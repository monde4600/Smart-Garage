...
/*===============SPI1 Configuration ======================*/
#define  SPI1_ENABLED       ENABLED
/*
  UNIDIRECTIONAL 
  BIDIRECTIONAL
*/
#define SPI1_BIDIMODE_MODE  UNIDIRECTIONAL
/*
 RECEIVE_ONLY 
 TRANSMIT_ONLY
*/                 
#define SPI1_BIDIOE_MODE    RECEIVE_ONLY
/*
  CRC_DISABLE
  CRC_ENABLE 
*/
...
/*
  ...
  SSM_ENABLED  
*/
#define SPI1_SSM_MODE       SSM_ENABLED
/*
  SSI_ENABLE  
  SSI_DISABLED
*/ 
#define SPI1_SSI_MODE       SSI_ENABLE
/*
  MSB
  LSB
*/
#define SPI1_LSB_FIRST      MSB
/*
  SPI_DISABLE
  SPI_ENABLE 
*/
...
/*
 ...
 F_CLK_256
*/
#define SPI1_BR_CONTROL     F_CLK_2
/*
  MASTER
  SLAVE 
*/
...
/*
  ...
  HIGH_POLARITY
*/
#define SPI1_CPOL_CONTROL   HIGH_POLARITY
/*
   READ_CLK_FIRST  
   WRITE_CLK_FIRST 
*/ 
#define SPI1_CPHA_CONTROL			WRITE_CLK_FIRST
/*=================SPI2 Configuration=============================*/
...
/*
 ...
 F_CLK_256
*/
#define SPI2_BR_CONTROL     F_CLK_2
/*
  MASTER
  SLAVE 
*/
